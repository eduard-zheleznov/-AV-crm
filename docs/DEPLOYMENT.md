...
Релиз `1.12.43.1` с обязательным инкогнито нельзя выкатывать поверх работающего
...
Для rollback `1.12.43.1` сначала остановите worker, затем откатите код к паре
`1.12.43` / `1.0.19` на commit
