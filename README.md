...
очередь на паузу, запускает каскад Telegram-уведомлений и автоматически
...
- Telegram-каскад при капче: сразу, напоминание и эскалация резервному человеку;
...
Настройка уведомлений: [docs/TELEGRAM.md](docs/TELEGRAM.md).
...
`.env`, токен Telegram, Google credentials, браузерный профиль, номера, CRM ID,
