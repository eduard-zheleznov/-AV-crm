...
- видимый Playwright Chromium (синий значок) и постоянный профиль;
...
- удалённый Google Sheets-пульт с уникальными ID команд, heartbeat, STOP и историей;
...
открывает тот же синий Chromium, который используется при обработке: можно войти,
...
**ЗАПУСТИТЬ В CRM**; статус и heartbeat видны в той же таблице.
