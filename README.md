...
очередь на паузу, запускает каскад email/Telegram-уведомлений и автоматически
...
- каскад Email/Telegram при капче: сразу, напоминание и эскалация резервному человеку;
...
Настройка уведомлений: [docs/EMAIL.md](docs/EMAIL.md) и
...
`.env`, SMTP-пароль, токен Telegram, Google credentials, браузерный профиль, номера, CRM ID,
